...
for i in range(len(choices)):
    ...
    if preference == "A":
        ...
        positive_hue_combinations.append((A_hsl[idx],anchor_hsl[idx]))
        
        negative_hue_combinations.append((anchor_hsl[idx],B_hsl[idx]))
        negative_hue_combinations.append((B_hsl[idx],anchor_hsl[idx]))
    
    elif preference == "B":
        negative_hue_combinations.append((anchor_hsl[idx],A_hsl[idx]))
        negative_hue_combinations.append((A_hsl[idx],anchor_hsl[idx]))
        
        positive_hue_combinations.append((anchor_hsl[idx],B_hsl[idx]))
        positive_hue_combinations.append((B_hsl[idx],anchor_hsl[idx]))
...
X = torch.concatenate([torch.Tensor(positive_hue_combinations),torch.Tensor(negative_hue_combinations)],dim=0)/360  #normalize to 0...1
